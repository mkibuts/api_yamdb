    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(auto_now_add=True, verbose_name='Дата написания')),
                ('score', models.SmallIntegerField(help_text='От 1 до 10', validators=[reviews.validators.validate_rating], verbose_name='Оценка')),
        ...
        migrations.AddConstraint(
            model_name='review',
            constraint=models.UniqueConstraint(fields=('author', 'title'), name='one_author_review'),
        ),
    ]
